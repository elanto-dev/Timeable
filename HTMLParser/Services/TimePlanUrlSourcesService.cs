...
namespace HTMLParser.Services
{
    internal class TimePlanUrlSourcesService
    {
        ...
        // open up any schedule from each study type, copy ical link and get pv=xxxx value 
        private Dictionary<StudyTypes, string> GroupLinkTemplate { get; set; } = new Dictionary<StudyTypes, string>
        {
            {
                StudyTypes.DayStudies,
                "https://ois.ttu.ee/pls/portal/tunniplaan.PRC_EXPORT_DATA?p_page=view_plaan&pn=i&pv=1&pn=e_sem&pv=342&pn=e&pv=-1&pn=b&pv=1&pn=g&pv=<GroupID>&pn=is_oppejoud&pv=false&pn=q&pv=1"
            },
            {
                StudyTypes.SessionStudies,
                "https://ois.ttu.ee/pls/portal/tunniplaan.PRC_EXPORT_DATA?p_page=view_plaan&pn=i&pv=1&pn=e_sem&pv=342&pn=e&pv=-1&pn=b&pv=2&pn=g&pv=<GroupID>&pn=is_oppejoud&pv=false&pn=q&pv=1"
            },
            {
                StudyTypes.DoctoralStudies,
                "https://ois.ttu.ee/pls/portal/tunniplaan.PRC_EXPORT_DATA?p_page=view_plaan&pn=i&pv=1&pn=e_sem&pv=342&pn=e&pv=-1&pn=b&pv=3&pn=g&pv=-1&pn=is_oppejoud&pv=false&pn=q&pv=neto"
            },
            {
                StudyTypes.FreeElectives,
                "https://ois.ttu.ee/pls/portal/tunniplaan.PRC_EXPORT_DATA?p_page=view_plaan&pn=i&pv=1&pn=e_sem&pv=342&pn=e&pv=-1&pn=b&pv=4&pn=g&pv=-1&pn=is_oppejoud&pv=false&pn=q&pv=neto"
            }
        };

        // https://ois.ttu.ee/pls/portal/ois2.ois_public.main
        // copy links from table head links js events
        // window.location='https://ois.ttu.ee/portal/page?_pageid=37,675060&_dad=portal&_schema=PORTAL&i=2&e=-1&e_sem=301&a=1&b=2&c=-1&d=-1&k=&q=neto&g=';
        private Dictionary<StudyTypes, string> GroupLinksSources { get; set; } = new Dictionary<StudyTypes, string>
        {
            {
                StudyTypes.DayStudies,
                "https://ois.ttu.ee/portal/page?_pageid=37,675060&_dad=portal&_schema=PORTAL&e=-1&e_sem=342&a=1&b=1&c=-1&d=-1&i=2&k=&q=neto&g="
            },
            {
                StudyTypes.SessionStudies,
                "https://ois.ttu.ee/portal/page?_pageid=37,675060&_dad=portal&_schema=PORTAL&i=2&e=-1&e_sem=342&a=1&b=2&c=-1&d=-1&k=&q=neto&g="
            },
            {
                StudyTypes.IntroductoryWeek,
                "https://ois.ttu.ee/portal/page?_pageid=37,675060&_dad=portal&_schema=PORTAL&e=-1&e_sem=342&a=1&b=5&c=-1&d=-1&i=2&k=&q=neto&g="
            },
