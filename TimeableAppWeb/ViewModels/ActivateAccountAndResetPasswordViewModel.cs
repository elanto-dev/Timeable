...
{
    public class ActivateAccountAndResetPasswordViewModel
    {
        ...
        public string AccountActivationCode { get; set; } = default!;
        public string PasswordResetCode { get; set; } = default!;
    }
}
